...
constexpr const flt_t cluster_redshift_scale = 0.000158041466531;
constexpr const flt_t cluster_redshift_median = 0.661315685092;
constexpr const flt_t cluster_redshift_min = 0.2;
constexpr const flt_t cluster_redshift_max = 1.30;
