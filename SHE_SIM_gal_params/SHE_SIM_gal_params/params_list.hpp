...
inline std::unordered_map<str_t,std::unique_ptr<ParamGenerator>> get_full_params_map(ParamHierarchyLevel & owner)
{
	std::unordered_map<str_t,std::unique_ptr<ParamGenerator>> res;
