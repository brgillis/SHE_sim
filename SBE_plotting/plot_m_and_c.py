...
def main(argv):
    ...
    for (low_SN_y_stderr_array, high_SN_y_stderr_array, y_limits, filename, y_label) in \
                    ((low_SN_m_cal_err_pix,high_SN_m_cal_err_pix,m_err_limits,"SBE_m_err_pix.eps",r"$\sigma(|m|)/(1+m)$ in pixel frame"),
                     (low_SN_m_cal_err_psf,high_SN_m_cal_err_psf,m_err_limits,"SBE_m_err_psf.eps",r"$\sigma(|m|)/(1+m)$ in psf frame"),
                     (low_SN_c_cal_err_pix,high_SN_c_cal_err_pix,c_err_limits,"SBE_c_err_pix.eps",r"$\sigma(|c|)/(1+m)$ in pixel frame"),
                     (low_SN_c_cal_err_psf,high_SN_c_cal_err_psf,c_err_limits,"SBE_c_err_psf.eps",r"$\sigma(|c|)/(1+m)$ in psf frame")):
